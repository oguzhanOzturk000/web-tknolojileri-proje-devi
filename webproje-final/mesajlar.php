...
<header>
    ...
    <div class="flexbox-container" >
        ...
        <div class="flexbox-2">
            <h2>Gönderenin Bilgileri</h2>
            İsim Soyisim: 
            <?php
                echo $_SESSION["nameSurname"]
            ?>
            <br><br>
            E-Mail:
            <?php
                echo $_SESSION["mesajMail"]
            ?><br><br>
            Şifre: 
            <?php
                echo $_SESSION["mesajSifre"]
            ?><br><br>
            Öğrenci Numarası(Giriş Yapıldıysa):
            <?php
            echo $_SESSION["password"];
            ?><br><br>
            Alternatif İletişim Linki:
            <?php
                echo $_SESSION["mesajUrl"]
            ?><br><br>
            Cinsiyet:
            <?php
            ...
            Doğum Tarihi:
            <?php
                echo $_SESSION["dogumTarihi"]
            ?><br><br>
            Mesajın Amacı:
            <?php
                echo $_SESSION["gerekceMesaj"]
            ?><br><br>
            <h2>Mesaj</h2>
            Mesaj:
            <?php
                echo $_SESSION["mesajBox"]
            ?><br><br>
            <p> Dosya(Varsa) </p>
            <?php
                echo $_SESSION["dosyaMesaj"]
            ?><br><br>
