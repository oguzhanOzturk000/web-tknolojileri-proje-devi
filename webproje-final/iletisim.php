    ...
    <div class="flexbox-container" >
        ...
        <div class="flexbox-2">
            <form action="" method="post">
                <div>
                    <label for="nameSurname">İsim Soyisim: </label><input type="text" name="nameSurname" class="textBox">                    
                    <label for="mesajMail">Email: </label><input type="email" name="mesajMail" class="textBox">
                    <label for="mesajSifre">Şifre: </label><input type="password" name="mesajSifre" class="textBox">
                    <br><br>
                    ...
                    <div class="input-wrapper">
                        ...
                        <div class="input-2">
                            ...
                            <br><input type="date" name="dogumTarihi" id="">
                            
                        </div>
                        <div class="input-3">
                            <label for="gerekceMesaj">Mesajınızın Amacı:</label><br>
                            <select name="gerekceMesaj" id="">
                                <option value="Belirtilemiş">Belirtilmemiş</option>
                ...
                <br>
                <div> <label for="mesajBox">Mesajınızı Girin: </label><input type="text" name="mesajBox" class="mesajBox"></div>
                <div class="input-wrapper">
                    <div><label for="dosyaMesaj">Mesajla İlgili Dosya Ekleyebilirsiniz: </label><input type="file" name="dosyaMesaj"></div>
                    <div><input type="checkbox" name="kabulMesaj" id="" class="checkBox" required><label for="kabulMesaj">Mesajımın Siteyi Daha İyi Hale Getirmek İçin İşlenmesini Kabul Ediyorum</label></div>
                ...
                <div>
                    <input type="submit" value="Gönder" class="mesajGonderBtn">    
                    <input type="reset" value="Sil" class="resetBtn">
                </div>
            </form>
            <a href="mesajlar.php">Gönderilen Mesajları Okumak İçin Tıklayın</a>
        </div>
...
<?php
    ...
    $_SESSION["mesajMail"]=$_POST["mesajMail"];
    $_SESSION["mesajSifre"]=$_POST["mesajSifre"];
    $_SESSION["mesajUrl"]=$_POST["mesajUrl"];
    $_SESSION["cinsiyetRadio"]=$_POST["cinsiyetRadio"];
    $_SESSION["dogumTarihi"]=$_POST["dogumTarihi"];
    $_SESSION["gerekceMesaj"]=$_POST["gerekceMesaj"];
    $_SESSION["mesajBox"]=$_POST["mesajBox"];
    $_SESSION["dosyaMesaj"]=$_POST["dosyaMesaj"];
    $_SESSION["kabulMesaj"]=$_POST["kabulMesaj"];
?>
