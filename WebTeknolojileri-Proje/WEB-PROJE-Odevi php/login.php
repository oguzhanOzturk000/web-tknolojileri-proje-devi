        ...
        <div class="div2 flexboxItem">
            ...
            <form action="login.php" method="post">
                <div class="inputContainer">
                    <input type="email"  placeholder="Kullanıcı Adı" name="username" class="usernameText">
                    <br>
                    <br>
                    <input type="password" placeholder="Şifre" name="password" class="passwordText">
                    <br>
                    <br>
                    <input type="submit" value="Giriş Yap!" class="loginButton">
                </div>
            </form>
        </div>
